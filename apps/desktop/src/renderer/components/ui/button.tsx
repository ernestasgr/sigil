...
const buttonVariants = cva(
    'sigil-btn-shine inline-flex items-center justify-center gap-2 font-ui text-sm tracking-widest uppercase border transition-colors disabled:pointer-events-none disabled:opacity-50',
    {
        variants: {
            variant: {
